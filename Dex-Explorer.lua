...
local Decompile do
	local Success, Decompile_Source = pcall(function()
		return game:HttpGet("https://raw.githubusercontent.com/gwnrdt/Not-Mine/refs/heads/main/Advanced-Decompiler-V3", true)
	end)
...
Main = (function()
	...
	Main.FetchRMD = function()
		...
		if Main.Elevated then
			...
			rawXML = rawXML or game:HttpGet("https://raw.githubusercontent.com/gwnrdt/Not-Mine/refs/heads/main/Roblox-Client-Tracker.xml")
		else
